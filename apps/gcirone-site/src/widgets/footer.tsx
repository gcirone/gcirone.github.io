      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-between md:flex-row">
          <div className="mb-6 md:mb-0">
            <a href="/" className="font-space text-xl font-bold text-orange-500">
              Gianluca Cirone
            </a>
            <p className="text-sm text-gray-200">Technical Director</p>
          </div>
          <div className="flex space-x-6">
            <a href="#" className="text-gray-400 transition hover:text-orange-500">
              <i data-feather="github" className="h-5 w-5">x</i>
            </a>
            <a href="#" className="text-gray-400 transition hover:text-orange-500">
